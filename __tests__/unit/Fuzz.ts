...
describe("VirtualIDE", () => {
    describe("fuzz test", () => {
        ...
        it("should not crash when trying to apply two dummy actions one after the other", () => {
            // arrange
            const virtualIDE = new VirtualIDE(undefined, undefined);
        ...
        it("should not crash when trying to apply three dummy actions one after the other", () => {
            // arrange
            const virtualIDE = new VirtualIDE(undefined, undefined);
